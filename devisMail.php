...
switch ($_SERVER['REQUEST_METHOD']) {
	...
	case ("POST"): //Send the email;
		 ...
		 $address = trim(stripslashes($params->address));
		 $cpVille =  trim(stripslashes($params->cpVille));
		 $category = trim(stripslashes($params->category));
		 $product = trim(stripslashes($params->productModel));
		 $qty = trim(stripslashes($params->qty));
		 $projectType = trim(stripslashes($params->projectType));
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper">
          <tr>
            <td align="center" valign="top" style="padding: 15px 0;" class="logo">
              <a href="#">
                <img alt="Logo" src="https://dpwstudio.com/lumia/assets/img/logo2.png" width="150"
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left"
                          ...
                          class="padding">Une personne a créée une demande de devis depuis le site, voici le détail :</td>
                      </tr>
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                      ...
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                          class="padding">Localisation => ' . $address . ' - '. $cpVille .'</td>
                      </tr>
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                      ...
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                          class="padding">Type de produit => ' . $category . '</td>
                      </tr>
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                          class="padding">Produit => ' . $product . '</td>
                      </tr>
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                          class="padding">Quantité => ' . $qty . '</td>
                      </tr>
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                          class="padding">Type de projet => ' . $projectType . '</td>
                      </tr>
                      <tr>
                        <td align="left"
                          style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica Neue, Arial, sans-serif; color: #666666;"
                          class="padding">Description => ' . $description . '</td>
                      </tr>
                    </table>
                  </td>
                </tr>
